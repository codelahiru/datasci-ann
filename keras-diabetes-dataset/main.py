...
# Load data
#dataset = loadtxt('/content/drive/MyDrive/ANN_Lecture/ANN_day4/new/diabetes.csv', delimiter=',')
dataset = np.loadtxt('data.csv', delimiter=',')
...
# Define the keras model
myANN = Sequential()
myANN.add(Dense(12, input_dim=8, activation='relu'))
...
# Fit the keras model on the dataset
myANN.fit(train_input, train_output, epochs=100, batch_size=10, verbose=1, validation_split=0.2)
